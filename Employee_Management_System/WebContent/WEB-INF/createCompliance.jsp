		...
		<div class="container" style="border: 2px solid green; padding: 30px; margin: 30px;">
			<form action="storeComplianceInformation.spring" method="post">
				...
				<div class="form-group" style="margin: 10px;">
					<label for="rltype" style="color:#47955b;font-family: Impact, Charcoal, sans-serif;font-size: 18px;letter-spacing: 2px;">Regulation Type</label>
					<input name="rltype" type="text" class="form-control" id="rltype" maxlength="15" required>
				</div>
				<div class="form-group" style="margin: 10px;">
					<label for="details" style="color:#47955b;font-family: Impact, Charcoal, sans-serif;font-size: 18px;letter-spacing: 2px;">RL Description</label>
					<input name="details" type="text" class="form-control" id="details" maxlength="250" required>
				</div>
				<div class="form-group" style="margin: 10px;">
					<label for="createdate" style="color:#47955b;font-family: Impact, Charcoal, sans-serif;font-size: 18px;letter-spacing: 2px;">Date of RL Creation</label>
					<input name="createdate" type="date" class="form-control" id="createdate" required>
				</div>
				<div class="form-group" style="margin: 10px;">
					<label for="department_id" style="color:#47955b;font-family: Impact, Charcoal, sans-serif;font-size: 18px;letter-spacing: 2px;">Department </label>
