...
<html>
	...
	<body>
		...
		<div class="container" style="border: 2px solid green; padding: 30px; margin: 30px;">
			<form action="editEmployeeDetails.spring" style="position: relative; top: 20px;" method="post">
				<div class="form-group" style="margin: 10px;">
					<label for="empid" style="color:#47955b;font-family: Impact, Charcoal, sans-serif;font-size: 18px;letter-spacing: 2px;">Employee-ID</label>
				...
				<div class="form-group" style="margin: 10px;">
					<label for="firstname" style="color:#47955b;font-family: Impact, Charcoal, sans-serif;font-size: 18px;letter-spacing: 2px;">First Name:</label>
					<input name="firstname" type="text" class="form-control" id="firstname" value=${employeeDetails.firstname} maxlength="45" required>
				</div>
				<div class="form-group" style="margin: 10px;">
					<label for="lastname" style="color:#47955b;font-family: Impact, Charcoal, sans-serif;font-size: 18px;letter-spacing: 2px;">Last Name:</label>
					<input name="lastname" type="text" class="form-control" id="lastname" value=${employeeDetails.lastname} maxlength="45" required>
				</div>
				<div class="form-group" style="margin: 10px;">
					<label for="dob" style="color:#47955b;font-family: Impact, Charcoal, sans-serif;font-size: 18px;letter-spacing: 2px;">DOB:</label>
					<input name="dob" type="date" class="form-control" id="dob" value=${employeeDetails.dob} required>
				</div>
				<div class="form-group" style="margin: 10px;">
					<label for="email" style="color:#47955b;font-family: Impact, Charcoal, sans-serif;font-size: 18px;letter-spacing: 2px;">Email id:</label>
					<input name="email" type="email" class="form-control" id="email" value=${employeeDetails.email} maxlength="100">
				</div>
				<div class="form-group" style="margin: 10px;">
					<label for="department_id" style="color:#47955b;font-family: Impact, Charcoal, sans-serif;font-size: 18px;letter-spacing: 2px;">Department ID:</label>
